...
# Cubre las 27 entradas del dataset de modelado (dataset_final_tfm.parquet):
#   - 24 features del modelo (ver FEATURES_NUM_MODELO en config_entorno.py)
#   - 1 target (abandono)
#   - 1 contexto (titulacion)
#   - 1 derivada para Fase 6 (rama)
#
# Estilo: abreviado y consistente con el resto de las etiquetas (paso 1
# del refactor SRC↔APP, decisión Opción 2).
#
# Uso:
...
ETIQUETAS_VARIABLES: Dict[str, str] = {
    ...
    # --- Variables añadidas en Fase 3 (feature engineering) ---
    # Refactor SRC↔APP: incluidas aquí para que ETIQUETAS_VARIABLES sea
    # fuente única de verdad y la app no necesite parches locales (_NOMBRES_EXTRA).
    # Estilo abreviado coherente con las etiquetas de arriba.
    'tasa_abandono_titulacion': 'Tasa aband. titulación',
    'cred_repetidos':           'Créd. repetidos',
    'tasa_repeticion':          'Tasa repetición',
    'n_anios_trabajando':       'Años trabaj.',
